...
-- Insight :
/*
A. The "CSAT Smoking Gun" (55 Churned)
...
B. The "Low Engagement" Risk (13.46% Churn)
...
C. The "SLA" Reality (48 Hours)
Result: Your 48h analysis shows 11.86% (High Res time) vs 9.81% (Less Res time).
