...
with single_tab:
        ...
        [
            {
                ...
                "resolution_observations_90d": resolution_observations_90d,
    ...
    if csat_responses_90d == 0:
        account_row["avg_csat_90d"] = np.nan

    if resolution_observations_90d == 0:
        account_row["avg_res_time_90d"] = np.nan
